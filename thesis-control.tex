\thispagestyle{empty}
\noindent\textbf{Студент} \begin{tabular}[t]{c} \underline{\hspace{5cm}} \\ {\scriptsize(ФИО)} \\ \end{tabular} Группа \underline{\hspace{2cm}} Кафедра\underline{\hspace{2cm}} Факультет \underline{\hspace{2cm}}

\bigskip

\noindent Направленность (профиль), специализация \underline{\hspace{10.5cm}}
